...
class UrlMapModel(BaseModel):
    ...
    origin_url: str = Field(max_length=2055, description='原链接')
...
class UrlMapUpdateModel(BaseModel):
    ...
    origin_url: str = Field(None, max_length=2055, description='原链接')
    status: int = Field(None, null=True, description='status')
...
class UrlMapUpdateRecordModel(BaseModel):
    ...
    token: str = Field(None, null=True, max_length=2055, description='原链接')
    status: int = Field(None, null=True, description='status')
